    ...
    >
      ...
      <div
        style={{
          ...
          background:
            "radial-gradient(circle, rgba(49,130,246,0.18), rgba(155,89,246,0.08), transparent 70%)",
      ...
      <div
        style={{
          ...
          transform: "translate(-50%, -50%)",
          background:
            "radial-gradient(circle, rgba(49,130,246,0.22), rgba(155,89,246,0.1), transparent 65%)",
      ...
      {bubblePhase !== null && (
        <div
          style={{
            ...
            animation:
              bubblePhase === "in"
                ? "rpBubbleIn 0.4s ease both"
                : "rpBubbleOut 0.5s ease both",
            pointerEvents: "none",
            display: "flex",
            alignItems: "center",
      ...
      <button
        ...
        style={{
          ...
          animation: "rpFabPulse 4s ease-in-out infinite",
        }}
      ...
      >
        <div style={{ animation: "rpFabWiggle 3s ease-in-out infinite" }}>
          <Asset.Icon
            name={"icon-emoji-money-with-wings" as IconName}
