![얼마냈지요 배너](./public/screenshot/썸네일2.png)

<br/>

# <img src="./public/screenshot/로고.png" width="48" align="center" /> 얼마냈지요 (HowMuch)
...
| :-------------------------------------------: | :--------------------------------------------------------: | :---------------------------------------------------------: | :--------------------------------------------------------------: |
| ![토스창](./public/screenshot/토스창.png) | ![토스 검색창](./public/screenshot/토스검색창.png) | ![어플 검색창](./public/screenshot/어플검색창.png) | ![미니앱 검색창](./public/screenshot/미니앱검색창.png) |
...
| :------------------------------------------------------: | :----------------------------------------------------------: | :--------------------------------------------------------------: | :---------------------------------------------------------: |
| ![메인 페이지](./public/screenshot/메인메이지.PNG) | ![금액 입력창](./public/screenshot/금액입력창.PNG) | ![경조사금 선택](./public/screenshot/경조사금선택.PNG) | ![금액 추천창](./public/screenshot/금액추천창.PNG) |
...
<p align="center">
  <img src="./public/screenshot/썸네일1.png" width="80%" alt="얼마냈지요 서비스 화면" />
</p>
